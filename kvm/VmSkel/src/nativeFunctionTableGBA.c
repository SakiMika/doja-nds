...
const NativeImplementationType com_sun_cldc_io_j2me_scratchpad_Protocol_natives[] = {
    { "nativeSize",      NULL, Java_com_sun_cldc_io_j2me_scratchpad_Protocol_nativeSize},
    { "nativeRead",      NULL, Java_com_sun_cldc_io_j2me_scratchpad_Protocol_nativeRead},
    { "nativeReadBytes", NULL, Java_com_sun_cldc_io_j2me_scratchpad_Protocol_nativeReadBytes},
    { "nativeWrite",     NULL, Java_com_sun_cldc_io_j2me_scratchpad_Protocol_nativeWrite},
    { "nativeWriteBytes",NULL, Java_com_sun_cldc_io_j2me_scratchpad_Protocol_nativeWriteBytes},
    { "nativeFlush",     NULL, Java_com_sun_cldc_io_j2me_scratchpad_Protocol_nativeFlush},
    NATIVE_END_OF_LIST
};
...
const ClassNativeImplementationType nativeImplementations[] = {
    ...
    { "com/sun/cldc/io/j2me/scratchpad", "Protocol", com_sun_cldc_io_j2me_scratchpad_Protocol_natives },
