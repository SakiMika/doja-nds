...
/* Pstros NDS patch: avoid compacting/permanent-space expansion on NDS.
 * The original compacting collector expands permanent memory by forcing GC
 * during class loading. On this port it can freeze at small Code allocations.
 */
#ifndef PSTROS_FORCE_NO_COMPACTION
#define PSTROS_FORCE_NO_COMPACTION 1
#endif
#if PSTROS_FORCE_NO_COMPACTION
#undef ENABLE_HEAP_COMPACTION
