...
public class RmsEnumeration implements RecordEnumeration {
	...
	public byte[] nextRecord()
		...
		RmsRecord record = group.getRecordAt(currentIndex);
		currentIndex++;
		if (record == null) {
			throw new InvalidRecordIDException();
		}
	...
	public int nextRecordId() throws InvalidRecordIDException {
		...
		if (MainApp.verbose) {
			System.out.println("RmsEnumeration: nextRecordId=" + record.getId());
		}
		return record.getId();
	}
	...
	public int previousRecordId() throws InvalidRecordIDException {
		...
		RmsRecord record = group.getRecordAt(currentIndex - 1);
		if (record == null) {
			throw new InvalidRecordIDException();
		}
		return record.getId();
