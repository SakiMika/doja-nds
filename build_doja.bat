...
echo ================================================
echo   DoJa i-appli to Nintendo DS - Direct DLDI Save Mount v25
echo ================================================
echo.
...
del /q "unprepared_doja_v25.nds" 2>nul
...
del /q "build_doja\prepared_v25.ok" 2>nul
...
set "ERR=%ERRORLEVEL%"
if not "%ERR%"=="0" (
    echo [ERROR] Source/JAR/metadata khong dong bo v25. Khong build.
    pause
    exit /b %ERR%
)
